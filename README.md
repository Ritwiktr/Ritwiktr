...
### 🧘 [TranquilAI](https://tranquilai.in)
*Mindfulness meets AI - Your personal AI therapist*

An intelligent mental wellness platform combining journaling, sleep tracking, and AI-powered meditation guidance.

- **Key Features:** AI-powered therapy sessions, journal analytics, sleep insights, personalized meditation
- **Tech Stack:** Flutter • Dart • Supabase • Firebase • OpenAI GPT API
- **Impact:** Helping users manage stress and improve mental health through AI assistance

---

### 📚 [BlogExplorer](https://github.com/Ritwiktr/blog_explorery)
*Discover and explore blogs with a modern mobile experience*

A feature-rich blog discovery app demonstrating advanced state management and clean architecture.

- **Key Features:** Blog feed, search functionality, bookmarking, dark mode
- **Architecture:** BLoC pattern for state management
- **Tech Stack:** Flutter • Dart • REST API
- **Learning Focus:** Advanced state management patterns and API integration

---

### 🌤️ [MeteoMate](https://github.com/Ritwiktr/MeteoMate--A-Weather-Forecast-App)
*Real-time weather forecasts at your fingertips*

A beautiful, intuitive weather app with detailed forecasts and location-based services.

- **Key Features:** Real-time weather, 7-day forecast, location search, weather alerts
- **Tech Stack:** Flutter • Dart • OpenWeatherMap API
- **Design Focus:** Clean UI with smooth animations
...
[![Portfolio](https://img.shields.io/badge/-Portfolio-FF6B6B?style=for-the-badge&logo=react&logoColor=white)](https://your-portfolio-link.com)
...
- 🚀 Constantly exploring new technologies in AI/ML space
- 📱 Mobile-first mindset in everything I build
- 🧠 Interested in the psychology of user experience
...
I'm always interested in discussing Flutter development, AI integration, or any exciting projects. Feel free to reach out or check out my repositories!

---

<div align="center">

**Made with ❤️ by Ritwik**  
